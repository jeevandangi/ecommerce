                    ...
                    <div className="sm:w-11/12 lg:w-3/4 mx-auto">
                        ...
                        <div className="flex flex-col p-4 sm:p-10 bg-white shadow-md rounded-xl  ">
                            ...
                            <div className="flex justify-between">
                                <div>
                                    <h1 className="mt-2 text-lg md:text-xl font-semibold text-blue-600  ">SnapDeal.</h1>
                                </div>
                                {/* Col */}
                            ...
                            <div className="mt-8 grid sm:grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-800  ">Sara Williams</h3>
                            ...
                            <div className="mt-6">
                                <div className="border border-gray-200 p-4 rounded-lg space-y-4 dark:border-neutral-700">
                                    <div className="hidden sm:grid sm:grid-cols-5">
                                        ...
                                        <div className="text-start text-xs font-medium text-gray-900 uppercase  ">Qty</div>
                                        <div className="text-start text-xs font-medium text-gray-900 uppercase  ">Rate</div>
                                        <div className="text-end text-xs font-medium text-gray-900 uppercase  ">Amount</div>
                                    </div>
                            ...
                            <div className="mt-8 sm:mt-12">
                                ...
                                <div className="mt-2">
                                    <p className="block text-sm font-medium text-gray-800  ">snapdeal@gmail.com</p>
                                    <p className="block text-sm font-medium text-gray-800  ">+977 9841891142</p>
                                </div>
                            </div>
                            <p className="mt-5 text-sm text-gray-500  ">© 2025 SnapDeal.</p>
                        </div>
                        {/* End Card */}
                        {/* Buttons */}
                        <div className="mt-6 flex justify-end gap-x-3" >
                            ...
                            <a onClick={() => reactToPrintFn()} className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="#">
